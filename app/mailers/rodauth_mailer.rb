class RodauthMailer < ApplicationMailer
  ...
  def verify_account(name, account_id, key)
    ...
    mail subject: @rodauth.email_subject_prefix + @rodauth.verify_account_email_subject, delivery_method_options: { version: "v3.1" }
  end
  ...
  def reset_password(name, account_id, key)
    ...
    mail subject: @rodauth.email_subject_prefix + @rodauth.reset_password_email_subject, delivery_method_options: { version: "v3.1" }
  end
  ...
  def verify_login_change(name, account_id, key)
    ...
    mail to: @new_email, subject: @rodauth.email_subject_prefix + @rodauth.verify_login_change_email_subject, delivery_method_options: { version: "v3.1" }
  end
